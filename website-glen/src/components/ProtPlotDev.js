...
//         //     data.append('proteinGroups', proteinGroupsFile, proteinGroupsFile.name);
//         // }
//         // if (colorFile !== null) {
//         //     data.append('colorFile', colorFile, colorFile.name);
//         // }
//         // if (ignoreDomainsFile !== null) {
//         //     data.append('ignoreDomains', ignoreDomainsFile, ignoreDomainsFile.name);
//         // }
